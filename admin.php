...
<div class="dashboard">
    ...
    <div class="card">
        <h2>Tour Requests</h2>
        <p>Manage and oversee all tour requests, including approvals and pending applications.</p>
        <a href="adminV.php" class="btn-custom">View Details</a>
    </div>

    <!-- Activities Request Card -->
    <div class="card">
        <h2>Activities Requests</h2>
        <p>Track and monitor activity requests for better planning and execution.</p>
        <a href="admin_dashboard.php" class="btn-custom">View Details</a>
    </div>

    <!-- Expenses Request Card -->
    <div class="card">
        <h2>Expenses Requests</h2>
        <p>Review and analyze expenses related to various operations and requests.</p>
        <a href="admin_confirmation.php" class="btn-custom">View Details</a>
    </div>
</div>
